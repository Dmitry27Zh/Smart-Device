...
gulp.task('server', function () {
  ...
  gulp.watch('source/js/main/*.js', gulp.series('javascript-main', 'refresh'));
});
...
gulp.task('build', gulp.series('clean', 'copy', 'css', 'images', 'webp', 'sprite', 'html', 'javascript-main', 'javascript-vendor'));
